...
public class AutoCompleteUtils {
	...
	public static ArrayList<String> autocomplete(String input) {
		...
		String jsonResults = "";
		try {
			inputStream = postPlaceSearch(ManyoujiaApi.PLAN_SEARCH_URL, params);
			Log.e("FFF", "inputStream:" + inputStream.toString());
		...
		try {
			...
			Log.e("FFF", "json:" + jsonResults.toString());
			
			JSONObject jsonObj = new JSONObject(jsonResults.toString());
			
			if (jsonObj.getInt("errorCode") == 0) {
				Log.e("FFF", "Place 获取成功");
				...
				Log.e("FFF", "Place 获取失败");
			}

		} catch (JSONException e) {
			Log.e("FFF", "Cannot process JSON results", e);
		}
	...
	public static InputStream postPlaceSearch(String path,
		...
		Log.e("TAG","SESSIONID: "+AsyncHttpLoader.SessionId);
		...
		Log.e("FFF", "2");
		Log.e("FFF", "Code: "+conn.getResponseCode());
		return null;
	}
}
