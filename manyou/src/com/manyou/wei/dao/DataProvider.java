...
* @Title: DataProvider.java 
* @Description: TODO
* @author firefist_wei firefist.wei@gmail.com   
* @date 2014-9-14 下午11:02:58 
* @version V1.0   
*/
package com.manyou.wei.dao;
...
public class DataProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.manyou.provider";
     ...
     */
    public static final String SHOT_CONTENT_TYPE = "vnd.android.cursor.dir/vnd.manyou.plan";
    ...
    private String matchTable(Uri uri) {
        ...
        switch (sUriMatcher.match(uri)) {
            case SHOTS:
                table = PlansDataHelper.ShotsDBInfo.TABLE_NAME;
                break;
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
        }
    ...
    public static class DBHelper extends SQLiteOpenHelper {
        // 数据库名
        private static final String DB_NAME = "manyoujia.db";
        ...
        public void onCreate(SQLiteDatabase db) {
        	PlansDataHelper.ShotsDBInfo.TABLE.create(db);
        }
